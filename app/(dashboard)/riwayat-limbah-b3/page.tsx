      ...
      <html>
        <head>
          ...
          <style>
            ...
            .no-form { border: 1px solid #000; display: inline-block; padding: 4px 12px; float: right; font-size: 12px; font-weight: bold; }
            h1 { text-align: center; font-size: 18px; margin: 0 0 2px; }
            h2 { text-align: center; font-size: 15px; margin: 0 0 20px; font-weight: normal; }
            table { width: 100%; border-collapse: collapse; margin-top: 10px; }
            td { border: 1px solid #000; padding: 6px 10px; font-size: 13px; }
            td.label { width: 40%; font-weight: bold; }
            td.value { color: #1a4fa0; font-weight: bold; }
            .catatan-box { border: 1px solid #000; border-top: none; padding: 30px 10px; font-size: 13px; }
            .catatan-title { border: 1px solid #000; border-bottom: none; text-align: center; font-weight: bold; padding: 4px; font-size: 13px; }
            .ttd-row { display: flex; justify-content: space-between; margin-top: 40px; text-align: center; }
            .ttd-col { width: 30%; font-size: 12px; }
            .ttd-col img { max-height: 70px; margin-bottom: 4px; }
            .ttd-line { margin-top: 4px; font-weight: bold; }
            .lampiran-title { font-weight: bold; margin-top: 30px; font-size: 13px; }
            .lampiran-title img { display: block; max-width: 100%; margin-top: 8px; border: 1px solid #ccc; }
          </style>
        </head>
        <body>
